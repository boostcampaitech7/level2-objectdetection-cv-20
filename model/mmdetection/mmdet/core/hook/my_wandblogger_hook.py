...
class MyMMDetWandbHook(WandbLoggerHook):
    ...
    def __init__(self,
                 ...
                 bbox_score_thr=0.3,
                 **kwargs):
        super(MyMMDetWandbHook, self).__init__(init_kwargs, interval, **kwargs)
    ...
    def before_run(self, runner):
        super(MyMMDetWandbHook, self).before_run(runner)
    ...
    def after_train_epoch(self, runner):
        super(MyMMDetWandbHook, self).after_train_epoch(runner)
    ...
    def after_train_iter(self, runner):
        if self.get_mode(runner) == 'train':
            ...
            return super(MyMMDetWandbHook, self).after_train_iter(runner)
        else:
            super(MyMMDetWandbHook, self).after_train_iter(runner)
