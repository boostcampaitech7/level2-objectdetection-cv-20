...
train_pipeline = [
        ...
        transforms=[
            [
                dict(
                    ...
                    keep_ratio=True),
                dict(type='RandomCrop', crop_size=(100, 100), bbox_clip_border=True),
            ],
            [
                dict(
                    type='RandomChoiceResize',
    ...
    dict(
        ...
        brightness_delta=10,  # 강도 감소
        saturation_range=(-15 / 255, 15 / 255),
        hue_delta=10
    ),    
    dict(
        type='Normalize',
...
test_evaluator = dict(
    ...
    classwise=True,
    backend_args=backend_args, 
    outfile_prefix='./work_dirs/ddq_recycle_gpt_c/result/ddq_w_tta')
